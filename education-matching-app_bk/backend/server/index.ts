...
import { DEFAULT_PORT, DEFAULT_NODE_ENV } from "./constants/env";
...
(async () => {
  try {
    ...
    app.use("/api/*", (req: Request, res: Response) => {
      sendError(res, "API endpoint not found", "NOT_FOUND", 404);
    });

    // Error logging middleware - logs errors to database
    // Note: This is error-handling middleware (4 params) and only runs when an error occurs
    app.use(errorLoggingMiddleware);

    // Final error handler - sends error response to client
